 ...
 */
public class MediaDecoder implements Decoder, SurfaceHolder.Callback {
    ...
    public int SURFACE_WIDTH = 2560;
    public int SURFACE_HEIGHT = 1600;
     ...
     */
    public MediaDecoder(SurfaceView surfaceView) {
     ...
     *
     */
    public MediaDecoder(SurfaceView surfaceView, Properties properties) {
    ...
    private class RTPClientThread extends Thread {
        ...
        public void run() {
            ...
            if ("time-window".equalsIgnoreCase(bufferType)) {
                rtpMediaExtractor = new RtpMediaExtractor(MediaDecoder.this);
